...
const config:Record<string,ModuleConfig>={
  ...
  'VAT & Tax Control':{title:'VAT & Tax Control',shortcuts:[{label:'VAT Working',href:'/dms/accounts/vat'},{label:'Transaction Review',href:'/dms/accounts/vat#transactions'},{label:'VAT Control',href:'/dms/accounts/vat#control'},{label:'Returns & Approval',href:'/dms/accounts/vat/returns'}]},
...
const allActions:Shortcut[]=[
  ...
  {label:'VAT Working',href:'/dms/accounts/vat'},
  {label:'VAT Returns & Approval',href:'/dms/accounts/vat/returns'},
